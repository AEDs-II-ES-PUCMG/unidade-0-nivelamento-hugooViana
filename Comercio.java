...
public class Comercio {
    ...
    */
    ...
    static void localizarProdutos(){
        ...
        produtoALocalizar = new ProdutoNaoPerecivel(descricao, precoCusto: 0.01);
    ...
    static void cadastrarProduto(){
        ...
        if (tipo == 1) {
            ...
            produtosCadastrados[quantosProdutos] = new ProdutoPerecivel(descricao, precoCusto, dataValidade);
            quantosProdutos++;
        } else if (tipo == 2) {
            System.out.print("Margem de lucro (%): ");
            double margemLucro = Double.parseDouble(teclado.nextLine()) / 100.0;
